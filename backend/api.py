...
def question():
    if request.method == "POST":
        ...
        values = int(age), int(smoke), int(yf), int(anxiety), int(disease), int(tired), int(allergy), int(
            wheeze), int(drink), int(cough), int(breath), int(swallow), int(chest), int(gender)
